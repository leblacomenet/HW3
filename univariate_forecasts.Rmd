...
```
Again, we find no alarming spikes in the residuals.
...
We will thus use a rolling window of 15 years.
...
eval['arima_v2'] = roll(1,0,0,0,1,1,FALSE)
eval['arima_v3'] = roll(1,0,0,0,1,1,TRUE)
eval['arima_v4'] = roll(2,0,0,1,1,1,FALSE)
eval['arima_v5'] = roll(4,0,0,0,1,1,FALSE)
